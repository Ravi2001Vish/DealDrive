...
//         alignItems:"center",
//         justifyContent:"center",
//         // backgroundColor:"rgba(157, 154, 154, 0.2)"
//       }}>
...
//         </li>
//         <li style={{color:"white" , margin:"10px", position:"relative"}} className='appuserli'><FaUserAlt  onClick={()=>userdetails("/userdetails")}/></li>
//         <div className='appuser'>User</div>
//      <div className='icndiv'><PiShoppingCartFill onClick={()=>{navigate("/cart")}}/>
